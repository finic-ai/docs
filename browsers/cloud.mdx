...
<CodeGroup>
```python Playwright (Python)
browser = playwright.chromium.connect(cdp_url="wss://browser.finic.io/?apikey=<your-finic-api-key>")
```
```typescript Puppeteer (NodeJS)
const browser = await puppeteer.connect({ browserWSEndpoint: 'wss://browser.finic.io/?apikey=<your-finic-api-key>' });
```
</CodeGroup>
